...
@section('conteudo')
    ...
    <form action="{{ route('servico.update', ['id' => $servico->id]) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="telefone" class="form-control" id="telefone" value="{{ old('telefone', $servico->telefone) }}">
        </div>

        <div class="mb-3">
            <label for="celular" class="form-label">Celular</label>
            <input type="text" name="celular" class="form-control" id="celular" value="{{ old('celular', $servico->celular) }}">
        </div>
